...
<?php
  ...
  function widget($args, $instance)
  {
    ...
    <form class="idx-omnibar-form">
      <input class="idx-omnibar-input" type="text" placeholder="City, County, Zipcode, Address or MLS Number" onblur="if (this.value == '') {this.value = 'City, County, Zipcode, Address or MLS Number';}" onfocus="if (this.value == 'City, County, Zipcode, Address or MLS Number') {this.value = '';}"><input type="submit" value="Search">
    </form>
